...
const MenuSection = () => {
  ...
  return (
    <section id="menu" className="py-20 bg-charcoal w-full"> {/* Changed background */}
      <div className="section-wrapper">
        ...
        >
          <div className="flex flex-col items-center justify-center mb-6">
            <h2 className="section-title section-title-decorated section-title-centered text-5xl mb-8 text-goldTan">Our Menu</h2> {/* Changed text color */}
            <div className="w-24 h-1 bg-gold rounded-full"></div> {/* Corrected color name */}
          </div>
          <p className="body-text max-w-2xl mx-auto text-xl leading-relaxed font-medium text-ivory"> {/* Changed text color */}
        ...
        <div className="flex justify-center mb-16 w-full">
          <div className="inline-flex p-2 rounded-xl bg-warmGray-800 shadow-inner"> {/* Changed background */}
              ...
              <motion.button
                ...
                className={`tab-focus px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center ${
                  activeCategory === category.id 
                    ? 'bg-gold text-charcoal shadow' // Changed active text color
                    : 'bg-transparent text-ivory hover:bg-gold/20' // Changed inactive text color
                }`}

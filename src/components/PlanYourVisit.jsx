...
const PlanYourVisit = () => {
  ...
  const mapAddress = encodeURIComponent(businessInfo.address);
    return (
    <section id="visit" className="py-16 bg-(--color-warmGray) w-full">
            ...
            <div className="space-y-6 w-full">              <motion.div
              ...
              >                <div className="flex items-start">
                  <div className="mr-4 mt-1">
                    ...
                    <h3 className="subtitle mb-2 font-display">Parking</h3>
                    <p className="body-text text-(--color-ivory)">
                      Free parking available in the visitor lot. Street parking also available on College Street.
                    </p>
                  </div>
                </div>
              </motion.div>                <motion.div
                className="bg-(--color-cardBg) rounded-lg shadow-md p-6 border-l-4 border-(--color-gold) hover:shadow-lg hover:glow-gold hover:translate-y-[-2px] hover:border-l-6 transition-all duration-300"
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
              ...
              >
                <div className="flex items-start">
                  <div className="mr-4 mt-1">
                    <div className="w-10 h-10 bg-(--color-gold/10) rounded-full flex items-center justify-center">
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        className="h-5 w-5 text-(--color-garnet)" 
                        fill="none" 
                    ...
                    <h3 className="subtitle mb-2 font-display">Public Transportation</h3>
                    <p className="body-text text-(--color-ivory)">
                      Bus routes 10 and 15 stop directly in front of our location. Campus shuttle service available every 30 minutes.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <h3 className="subtitle mb-4 font-display">Quick Directions</h3>
